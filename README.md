...
- the workspace switcher reserves side space so neighboring toolbar buttons do not overlap it
...
- The workspace switcher keeps side spacing around it so adjacent toolbar icons stay separate at every size.
