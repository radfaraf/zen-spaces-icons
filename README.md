...
- the workspace switcher can scroll horizontally when there is not enough room
...
- When the workspace switcher is too tight, scroll left or right over the space icons to reach hidden spaces.
